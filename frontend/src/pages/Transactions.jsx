  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="flex items-center justify-between">
        <h1 className="text-xl sm:text-2xl font-bold text-gray-800">Transaksi</h1>
        <button
          onClick={openAdd}
      ...
      {/* Filters */}
      <div className={`${showFilters ? 'block' : 'hidden'} sm:block bg-white rounded-2xl shadow-sm border border-gray-100 p-4`}>
        ...
        {/* Mobile clear button */}
        {activeFilterCount > 0 && (
          <button onClick={clearFilters} className="sm:hidden w-full mt-2.5 text-xs text-blue-600 font-medium py-1.5">
            Reset Filter
          </button>
        )}
      </div>
        ...
        {loading ? (
          ...
          transactions.map((t) => {
            ...
            return (
              <div
                key={t.id}
                className="bg-white rounded-xl border border-gray-100 p-3.5 active:bg-gray-50 transition-colors"
                onClick={() => openEdit(t)}
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-1.5 mt-0.5">
                      <span className="text-xs text-gray-400">{t.category_name}</span>
                  ...
                  <div className="text-right shrink-0">
                    ...
                    <button
                      ...
                      className="mt-0.5 p-1 hover:bg-red-50 rounded-lg transition-colors ml-auto"
                    >
      ...
      >
        <div className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-gray-600 mb-2">Tipe</label>
          ...
          <div>
            ...
            <input
              ...
              className="w-full border border-gray-200 rounded-xl px-3 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 text-lg font-semibold"
              placeholder="100000"
              required
              inputMode="numeric"
            />
