    ...
    <>
      ...
      <div className="fixed inset-0 z-[70] flex items-end sm:items-center justify-center pointer-events-none">
        ...
        <div className="hidden sm:block w-full max-w-md pointer-events-auto">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl mx-4 max-h-[85vh] overflow-hidden flex flex-col transition-colors">
        ...
        <div className="sm:hidden w-full pointer-events-auto">
          <div className="bg-white dark:bg-gray-800 rounded-t-3xl shadow-2xl max-h-[92vh] overflow-hidden flex flex-col transition-colors">
            {/* Drag handle */}
            <div className="flex justify-center pt-3 pb-1 shrink-0">
              <div className="w-10 h-1 bg-gray-300 dark:bg-gray-600 rounded-full" />
            </div>
            <div className="flex items-center justify-between px-5 py-3 border-b border-gray-50 dark:border-gray-700 shrink-0">
